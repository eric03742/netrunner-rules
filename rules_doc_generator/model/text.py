...
class Card:
  ...
  def to_html(self, config: Config, model_data: ModelData) -> str:
    if self.text in model_data.nrdb_info:
      ...
      return f'<a class="Thumbnail Card" href="https://netrunnerdb.com/en/card/{id}">{self.text}<span><img src="preview_placeholder.jpg" data-src="https://printing.sneakdoorbeta.net/zh/large/{id}.webp" /></span></a>'
    else:
